			...
			<tbody>
				...
				foreach ($customer as $s => $d) {
					...
					<tr>
						...
						<td><a href="<?php echo base_url(); ?>index.php/customer/detil/<?php echo $d['kd_customer']; ?>">
							<button class="btn btn-primary">Detil</button>
					</a> | <a href="<?php echo base_url(); ?>index.php/customer/edit/<?php echo $d['kd_customer']; ?>">
							<button class="btn btn-secondary">Edit</button>
				</a> | <a href="<?php echo base_url(); ?>index.php/customer/hapus/<?php echo $d['kd_customer']; ?>">
